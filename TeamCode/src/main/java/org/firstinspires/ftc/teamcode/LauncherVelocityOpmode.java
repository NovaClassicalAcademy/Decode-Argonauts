...
public class LauncherVelocityOpmode extends LinearOpMode {

    private DcMotorEx launcher = null;
    private ElapsedTime timer = new ElapsedTime();

    // --- CONFIGURE THESE for your hardware ---
    private static final String LAUNCHER_NAME = "outtakeMotor"; // hardware map name
    ...
    private static final double TARGET_RPM = 4800; // example; change to what you need
